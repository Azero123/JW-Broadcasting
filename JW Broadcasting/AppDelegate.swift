    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        */
        ...
        fetchDataUsingCache("https://www.jw.org/apps/E_RSSMEDIAMAG?rln=E&rmn=wp&rfm=m4b", downloaded: {
            ...
            unfold("https://www.jw.org/apps/E_RSSMEDIAMAG?rln=E&rmn=wp&rfm=m4b")
        })
        print("rss finished")*/
        
        /*do {
            
            let rss = try NSString(contentsOfURL: NSURL(string: "https://www.jw.org/apps/E_RSSMEDIAMAG?rln=E&rmn=wp&rfm=m4b")!, encoding: NSUTF8StringEncoding)
            
            //let rss=try String(contentsOfFile: "https://www.jw.org/apps/E_RSSMEDIAMAG?rln=E&rmn=wp&rfm=m4b")
            print(rss)
        }
        catch {
            print("error reading rss")
        }*/
